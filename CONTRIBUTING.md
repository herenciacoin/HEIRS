Contributing to HERENCIA Core
============================

The HERENCIA Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/herencia-project/herencia/blob/master/doc/translation_process.md)
...
The following applies to code changes to the HERENCIA Core project, and is not to be
confused with overall HERENCIA Network Protocol consensus changes.

Whether a pull request is merged into HERENCIA Core rests with the project merge
...
Patches that change HERENCIA consensus rules are considerably more involved than
...
Where a patchset proposes to change the HERENCIA consensus, it must have been
...
The project leader is the release manager for each HERENCIA Core release.
