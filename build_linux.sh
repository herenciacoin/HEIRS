...
# Create zip file of binaries
	cp herencia/src/herenciad herencia/src/herencia-cli herencia/src/herencia-tx herencia/src/qt/herencia-qt .
	zip HEIRS-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip herenciad herencia-cli herencia-tx herencia-qt
	rm -f herenciad herencia-cli herencia-tx herencia-qt
