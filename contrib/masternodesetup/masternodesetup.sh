...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='herencia.conf'
CONFIGFOLDER='/root/.herencia'
COIN_DAEMON='herenciad'
COIN_CLI='herencia-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/herencia/HEIRS/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
