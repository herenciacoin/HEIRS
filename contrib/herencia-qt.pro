...
RESOURCES += src/qt/herencia.qrc src/qt/herencia_locale.qrc

TRANSLATIONS += src/qt/locale/herencia_bg.ts \
                src/qt/locale/herencia_de.ts \
                src/qt/locale/herencia_en.ts \
                src/qt/locale/herencia_es.ts \
                src/qt/locale/herencia_fi.ts \
                src/qt/locale/herencia_fr.ts \
                src/qt/locale/herencia_it.ts \
                src/qt/locale/herencia_ja.ts \
                src/qt/locale/herencia_pl.ts \
                src/qt/locale/herencia_pt.ts \
                src/qt/locale/herencia_ru.ts \
                src/qt/locale/herencia_sk.ts \
                src/qt/locale/herencia_sv.ts \
                src/qt/locale/herencia_vi.ts \
                src/qt/locale/herencia_zh_CN.ts \
                src/qt/locale/herencia_zh_TW.ts
