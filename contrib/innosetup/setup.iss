...
#define MyAppName "HERENCIA Core"
#define MyAppPublisher "2023 HERENCIA Core Developers"
#define MyAppURL "https://herencia.net"
#define MyAppExeName "herencia-qt.exe"
#define MyAppExtraData "https://explorer.herencia.net/bootstraps/HEIRS/bootstrap.zip"
...
DefaultDirName={autopf}\HERENCIA
...
OutputDir=.\output
OutputBaseFilename=HERENCIASetup
...
DefaultGroupName=HERENCIA Core
...
[Files]
Source: ".\package\herencia-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\HERENCIA\HERENCIA-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\HERENCIA\HERENCIA-Qt,strDataDir|{userappdata}\HERENCIA\}');
  Result := True;
end;
