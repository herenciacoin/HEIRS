...
{
    const char* pszTimestamp = "Crypto tracker picks up trail of funds heisted from Harmony Bridge in June";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256S("0x0000073d1faf35960ce36ffb15f10f5aadbf018b2651ae354dd69a539c769b6d"))	
    (501, uint256S("0xd81949112023e345a06896cc5a68ba30f47084be5c3c7331d5bbd6ece1624b8e"))	
    (1412, uint256S("0xaa0dd9ea15bb1fe14b686fb0459157dff99b323e967f047da0f624f0ca2f8320"))	
    (2614, uint256S("0xc7f1f8577cdf6404ef892a961bfc125eecf87c1f8ed8731a105d3e7fd51bfa79"))	
    (3140, uint256S("0x2a53dc590a4a1efa06deb47eab7e58c49af4ca22a181d449fa02471130269ff9"))
    (4590, uint256S("0xf1a22022335955a8e8656e76aa07ae530be55610ba4259d04d04c347b3546f71"))	
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1674790200, 362565, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000073d1faf35960ce36ffb15f10f5aadbf018b2651ae354dd69a539c769b6d"));
        assert(genesis.hashMerkleRoot == uint256S("0x245c09dbd0f3570cec149cb90a8101e378b3b3e1a26b58a731a94b99ff4ac018"));
        ...
        // spork keys
        consensus.strSporkPubKey = "04397c25919f437c6c39f82295c58a99a814a60a94dff8d8d150ff08c57cd569aac1fb5a331cc1e52edd1af5cd8e25c5b831c7f8e5c76ed05c2a4fdc45494aa249";
        ...
        vSeeds.push_back(CDNSSeedData("155.138.133.74", "155.138.133.74"));
	    vSeeds.push_back(CDNSSeedData("155.138.149.55", "155.138.149.55"));
        vSeeds.push_back(CDNSSeedData("155.138.143.166", "155.138.143.166"));
        vSeeds.push_back(CDNSSeedData("155.138.150.227", "155.138.150.227"));
        vSeeds.push_back(CDNSSeedData("155.138.157.121", "155.138.157.121"));
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // herencia starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        vSeeds.push_back(CDNSSeedData("tseeder", "tseeder.herencia.net"));
	    vSeeds.push_back(CDNSSeedData("tseed1", "tseed1.herencia.net"));
        vSeeds.push_back(CDNSSeedData("tseed2", "tseed2.herencia.net"));
        vSeeds.push_back(CDNSSeedData("tseed3", "tseed3.herencia.net"));
        vSeeds.push_back(CDNSSeedData("tseed4", "tseed4.herencia.net"));
	    vSeeds.push_back(CDNSSeedData("tseed5", "tseed5.herencia.net"));
	    vSeeds.push_back(CDNSSeedData("tseed6", "tseed6.herencia.net"));
	    vSeeds.push_back(CDNSSeedData("tseed7", "tseed7.herencia.net"));
	    vSeeds.push_back(CDNSSeedData("tseed8", "tseed8.herencia.net"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet herencia addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet herencia script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet herencia BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet herencia BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet herencia BIP44 coin type is '1' (All coin's testnet default)
