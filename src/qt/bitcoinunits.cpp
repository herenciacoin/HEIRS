...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(HEIRS);
    unitlist.append(mHEIRS);
    unitlist.append(uHEIRS);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case HEIRS:
        return QString("HEIRS");
    case mHEIRS:
        return QString("mHEIRS");
    case uHEIRS:
        return QString::fromUtf8("uHEIRS");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZHEIRS)
{
    QSettings settings;
...
QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZHEIRS)
{
