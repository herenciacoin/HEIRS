...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, HERENCIAGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, HERENCIAGUI* gui, double posX = 3);
