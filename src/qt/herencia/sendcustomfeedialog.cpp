...
#include "qt/herencia/sendcustomfeedialog.h"
#include "qt/herencia/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(HERENCIAGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &HERENCIAGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
