...
#include "qt/herencia/forms/ui_masternodeswidget.h"

#include "qt/herencia/qtutils.h"
#include "qt/herencia/mnrow.h"
#include "qt/herencia/mninfodialog.h"
#include "qt/herencia/masternodewizarddialog.h"
...
#include "util.h"
#include "qt/herencia/optionbutton.h"
#include <iostream>
#include <fstream>
...
MasterNodesWidget::MasterNodesWidget(HERENCIAGUI *parent) :
    PWidget(parent),
    ...
    if (fs::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:7255 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
