...
#include "qt/herencia/forms/ui_topbar.h"
#include "qt/herencia/loadingdialog.h"
#include "qt/herencia/lockunlock.h"
#include "qt/herencia/qtutils.h"
#include "qt/herencia/receivedialog.h"
...
TopBar::TopBar(HERENCIAGUI* _mainWindow, QWidget* parent) : PWidget(_mainWindow, parent),
                                                        ui(new Ui::TopBar)
{
    ui->setupUi(this);
    ...
    ui->pushButtonConf->setButtonText("herencia.conf");
...
void TopBar::onBtnConfClicked()
{
    ...
    if (!GUIUtil::openConfigfile())
        inform(tr("Unable to open herencia.conf with default application"));
}
