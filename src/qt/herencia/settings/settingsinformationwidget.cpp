...
#include "qt/herencia/settings/settingsinformationwidget.h"
#include "qt/herencia/settings/forms/ui_settingsinformationwidget.h"
...
SettingsInformationWidget::SettingsInformationWidget(HERENCIAGUI* _window,QWidget *parent) :
