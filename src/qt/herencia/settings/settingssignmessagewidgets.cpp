...
#include "qt/herencia/settings/settingssignmessagewidgets.h"
#include "qt/herencia/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(HERENCIAGUI* _window, QWidget *parent) :
