...
#include "qt/herencia/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/herencia/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(HERENCIAGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableHEIRS,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableHEIRS,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableHEIRS,
    ...
    setCssProperty({
              ui->pushButton_Intro,
              ui->pushButton_UnspendableHEIRS,
              ui->pushButton_Stake,
    ...
    connect(ui->pushButton_UnspendableHEIRS, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableHEIRS);});
    ...
    if (parent)
        connect(parent, &HERENCIAGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
