...
#include "qt/herencia/settings/settingsbackupwallet.h"
#include "qt/herencia/settings/forms/ui_settingsbackupwallet.h"
#include <QFile>
...
#include "qt/herencia/qtutils.h"
SettingsBackupWallet::SettingsBackupWallet(HERENCIAGUI* _window, QWidget *parent) :
