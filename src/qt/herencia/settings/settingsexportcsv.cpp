...
#include "qt/herencia/settings/settingsexportcsv.h"
#include "qt/herencia/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(HERENCIAGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("HERENCIA_tx_csv_export(*.csv)") : tr("HERENCIA_addresses_csv_export(*.csv)"),
                                        nullptr);
