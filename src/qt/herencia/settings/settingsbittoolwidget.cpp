...
#include "qt/herencia/settings/settingsbittoolwidget.h"
#include "qt/herencia/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(HERENCIAGUI* _window, QWidget *parent) :
