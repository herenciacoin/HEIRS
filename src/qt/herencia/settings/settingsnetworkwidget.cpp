...
#include "qt/herencia/settings/settingsnetworkwidget.h"
#include "qt/herencia/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/herencia/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(HERENCIAGUI* _window, QWidget *parent) :
