...
#include "qt/herencia/settings/settingswalletrepairwidget.h"
#include "qt/herencia/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/herencia/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(HERENCIAGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to HERENCIAGUI::handleRestart()
