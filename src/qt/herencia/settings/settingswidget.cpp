...
#include "qt/herencia/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(HERENCIAGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &HERENCIAGUI::openFAQ);
