...
#include "qt/herencia/settings/settingswalletoptionswidget.h"
#include "qt/herencia/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/herencia/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(HERENCIAGUI* _window, QWidget *parent) :
