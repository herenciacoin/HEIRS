...
#include "qt/herencia/settings/settingsconsolewidget.h"
#include "qt/herencia/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/herencia/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(HERENCIAGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the HEIRS RPC console.") + "<br>" +
