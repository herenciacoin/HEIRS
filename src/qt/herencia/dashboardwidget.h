...
#include "qt/herencia/furabstractlistitemdelegate.h"
#include "qt/herencia/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/herencia/txviewholder.h"
...
#include "config/herencia-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    explicit DashboardWidget(HERENCIAGUI* _window);
    ~DashboardWidget();
