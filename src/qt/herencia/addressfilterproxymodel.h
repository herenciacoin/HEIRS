...
#ifndef HERENCIA_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define HERENCIA_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //HERENCIA_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
