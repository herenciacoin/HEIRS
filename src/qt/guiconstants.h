...
/* HERENCIA GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "HERENCIA"
#define QAPP_ORG_DOMAIN "herencia.org"
#define QAPP_APP_NAME_DEFAULT "HERENCIA-Qt"
#define QAPP_APP_NAME_TESTNET "HERENCIA-Qt-testnet"
