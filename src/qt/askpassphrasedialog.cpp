...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            HERENCIAGUI* window = static_cast<HERENCIAGUI*>(parentWidget());
...
{
    HERENCIAGUI* gui = static_cast<HERENCIAGUI*>(parentWidget());
...
{
    hide();
    static_cast<HERENCIAGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("HERENCIA will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your HEIRSs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
