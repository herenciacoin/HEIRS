...
/** Utility functions used by the HERENCIA Qt UI.
 */
namespace GUIUtil
{
...
// Render HEIRS addresses in monospace font
...
// Parse "herencia:" URI into recipient object, return true on successful parsing
