...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop HERENCIA server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "HERENCIA server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HEIRS features */
        {"herencia", "listmasternodes", &listmasternodes, true },
        {"herencia", "getmasternodecount", &getmasternodecount, true },
        {"herencia", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"herencia", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"herencia", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"herencia", "masternodecurrent", &masternodecurrent, true },
        {"herencia", "startmasternode", &startmasternode, true },
        {"herencia", "createmasternodekey", &createmasternodekey, true },
        {"herencia", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"herencia", "listmasternodeconf", &listmasternodeconf, true },
        {"herencia", "getmasternodestatus", &getmasternodestatus, true },
        {"herencia", "getmasternodewinners", &getmasternodewinners, true },
        {"herencia", "getmasternodescores", &getmasternodescores, true },
        {"herencia", "preparebudget", &preparebudget, true },
        {"herencia", "submitbudget", &submitbudget, true },
        {"herencia", "mnbudgetvote", &mnbudgetvote, true },
        {"herencia", "getbudgetvotes", &getbudgetvotes, true },
        {"herencia", "getnextsuperblock", &getnextsuperblock, true },
        {"herencia", "getbudgetprojection", &getbudgetprojection, true },
        {"herencia", "getbudgetinfo", &getbudgetinfo, true },
        {"herencia", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"herencia", "mnfinalbudget", &mnfinalbudget, true },
        {"herencia", "checkbudgets", &checkbudgets, true },
        {"herencia", "mnsync", &mnsync, true },
        {"herencia", "spork", &spork, true },
...
{
    return "> herencia-cli " + methodname + " " + args + "\n";
}
