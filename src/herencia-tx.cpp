...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("HERENCIA herencia-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  herencia-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded herencia transaction") + "\n" +
                               "  herencia-tx [options] -create [commands]   " + _("Create hex-encoded herencia transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded herencia transaction
