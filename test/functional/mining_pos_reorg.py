...
from test_framework.test_framework import HerenciaTestFramework
...
class ReorgStakeTest(HerenciaTestFramework):
    ...
    def check_money_supply(self, expected_heirs, expected_zheirs):
        ...
        # verify that nodes have the expected HEIRS and zHEIRS supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_heirs))
            for denom in node['zHEIRSsupply']:
                assert_equal(node['zHEIRSsupply'][denom], DecimalAmt(expected_zheirs[denom]))
    ...
    def run_test(self):
        ...
        # Check HEIRS and zHEIRS supply at the beginning
        # ------------------------------------------
        # zHEIRS supply: 2 coins for each denomination
        ...
        # HEIRS supply: block rewards minus burned fees for minting
        ...
        # Verify that HEIRS and zHEIRS supplies were properly updated after the spends and reorgs
        self.log.info("Check HEIRS and zHEIRS supply...")
