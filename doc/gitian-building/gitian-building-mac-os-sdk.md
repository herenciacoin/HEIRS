...
The script [extract-osx-sdk.sh](https://github.com/herencia-project/herencia/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
herencia/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/herencia-project/herencia/blob/master/doc/README_osx.md) for troubleshooting tips.
