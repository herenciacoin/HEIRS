...
# Create zip file of binaries
	cp herencia/src/herenciad.exe herencia/src/herencia-cli.exe herencia/src/herencia-tx.exe herencia/src/qt/herencia-qt.exe .
	zip HEIRS-Windows.zip herenciad.exe herencia-cli.exe herencia-tx.exe herencia-qt.exe
	rm -f herenciad.exe herencia-cli.exe herencia-tx.exe herencia-qt.exe
